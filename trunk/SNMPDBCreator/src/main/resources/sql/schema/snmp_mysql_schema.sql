...
INSERT INTO ROLE values ('USER');
  ...
  CREATE TABLE CONFIGMAP
   (	DEVICEID INT(11),
	CONFIGID INT(11),
      CONSTRAINT FK_CONFIGMAP_DEVICECONFIG FOREIGN KEY (CONFIGID) REFERENCES DEVICECONFIG (ID),
      CONSTRAINT FK_CONFIGMAP_DEVICE FOREIGN KEY (DEVICEID) REFERENCES DEVICE (ID)
   ) ;
